...
> **Local modification notice (2026-08-26):** Compared with upstream commit
> `63b04e2530f5c7b41ea83c133daab24f34912456`, the YAML frontmatter was adapted
> for Codex compatibility: `version` and `argument-hint` were moved into
> `metadata`, and the unsupported `user-invocable` field was removed.
